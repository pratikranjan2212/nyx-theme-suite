...
- **True Dark**: Elegant dark grey/almost black background flat across all panels for unified aesthetics.
- **True Dark Islands**: The same refined color palette, but with contrasting sidebar and status panel backgrounds to make the editor stand out as a clean, centered "island".

### 2. Black Themes (`#000000`)
- **True Black**: Pure pitch-black background flat across the entire editor and sidebar to maximize contrast, perfect for OLED screens and reducing eye strain.
- **True Black Islands**: A pure black editor framed by dark grey sidebar panels for a structured layout.

### 3. Light Themes (`#F2F4FE`)
- **True Light**: An exceptionally clean light theme with a cool, soft blue-white background.
- **True Light Islands**: The same premium light palette, featuring a pure white editor contrasted by soft blue-white side panels.
...
- **Pure Black (OLED) Support**: The **True Black** variant uses pure black (`#000000`) to save battery on OLED screens and minimize screen glare.
...
3. Type `ext install true-dark` and press **Enter**.
